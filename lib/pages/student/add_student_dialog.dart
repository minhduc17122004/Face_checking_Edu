...
class AddStudentDialog extends StatefulWidget {
  const AddStudentDialog({super.key, required this.hasServerConfig});
...
class _AddStudentDialogState extends State<AddStudentDialog> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final result = await studentBloc.onRegisterStudent(
          registerStudent, widget.hasServerConfig);
      ...
      if (mounted && result) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(studentBloc.state.error ?? 'Lỗi thêm học sinh'),
            backgroundColor: Colors.red,
          ),
        );
      }
